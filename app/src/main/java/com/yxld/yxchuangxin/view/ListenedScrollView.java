...
public class ListenedScrollView extends ScrollView {
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        KLog.d(TAG, "t = " + t + ", oldt = " + oldt);

        if (inTouch) {
            if (t != oldt) {
                // 有手指触摸，并且位置有滚动
                KLog.i(TAG, "SCROLL_STATE_TOUCH_SCROLL");
    ...
    private Handler checkStateHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (lastT == getScrollY()) {
                ...
                KLog.e(TAG, "SCROLL_STATE_IDLE");
                onScrollListener.onScrollStateChanged(ListenedScrollView.this, OnScrollListener.SCROLL_STATE_IDLE);
