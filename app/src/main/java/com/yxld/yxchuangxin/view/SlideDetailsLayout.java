...
public class SlideDetailsLayout extends ViewGroup {
        ...
        switch (aciton) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (canChildScrollVertically((int) yDiff)) {
                    shouldIntercept = false;
                        KLog.i("intercept, child can scroll vertically, do not intercept");
                } else {
                    ...
                    if (yDiffabs > mTouchSlop && yDiffabs >= xDiffabs
                        ...
                        if (isTop) {
                            ...
                            KLog.i("intercept, intercept events");
                    }
                }
                break;
            }
    ...
    public void setWebViewToTop (boolean isTop) {
        this.isTop = isTop;
    }
    ...
    private void processTouchEvent(final float offset) {
        ...
        if (mStatus == Status.CLOSE) {
            ...
            KLog.v("slide", "process, offset: " + mSlideOffset);
        // relayout
        requestLayout();
    }
    ...
    private void finishTouchEvent() {
        ...
        final float offset = mSlideOffset;
            ...
            KLog.d("slide", "finish, offset: " + offset + ", percent: " + percent);
