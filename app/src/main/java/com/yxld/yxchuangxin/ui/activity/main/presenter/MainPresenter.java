...
// TODO: 2018/5/11 维修流程
        ...
        params1.put("uuid", Contains.uuid);
        params1.put("baoxiuId", "711");
        Disposable disposable1 = httpAPIWrapper.getWeiXiuLiucheng(params1).subscribe(new Consumer<BaseEntity>() {
            @Override
