 ...
 * @Description: presenter of MineShopActivity
...
public class MineShopPresenter implements MineShopContract.MineShopContractPresenter{
    ...
    @Inject
    public MineShopPresenter(@NonNull HttpAPIWrapper httpAPIWrapper, @NonNull MineShopContract.View view, MineShopActivity activity) {
        mView = view;
