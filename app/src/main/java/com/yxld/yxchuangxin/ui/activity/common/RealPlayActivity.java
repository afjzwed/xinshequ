...
import com.yxld.yxchuangxin.Utils.EZUtils;
import com.yxld.yxchuangxin.Utils.SpUtil;
import com.yxld.yxchuangxin.application.AppConfig;
import com.yxld.yxchuangxin.base.BaseActivity;
import com.yxld.yxchuangxin.contain.ContainValue;
import com.yxld.yxchuangxin.ui.activity.common.component.DaggerRealPlayComponent;
...
import com.yxld.yxchuangxin.yingshi.ActivityUtils;
import com.yxld.yxchuangxin.yingshi.AudioPlayUtil;
import com.yxld.yxchuangxin.yingshi.DataManager;
import com.yxld.yxchuangxin.yingshi.LoadingTextView;
import com.yxld.yxchuangxin.yingshi.RealPlaySquareInfo;
import com.yxld.yxchuangxin.yingshi.ScreenOrientationHelper;
import com.yxld.yxchuangxin.yingshi.VerifyCodeInput;
import com.yxld.yxchuangxin.yingshi.WaitDialog;
...
public class RealPlayActivity extends BaseActivity implements RealPlayContract.View, View.OnClickListener, SurfaceHolder.Callback, Handler.Callback, View.OnTouchListener, VerifyCodeInput.VerifyCodeInputListener{

    @Inject
    RealPlayPresenter mPresenter;
...
//    private TitleBar mLandscapeTitleBar = null;
    ...
    /**
     * 监听锁屏解锁的事件 RealPlayBroadcastReceiver
     */
    ...
    protected void setupActivityComponent() {
       DaggerRealPlayComponent
               .builder()
               .appComponent(((AppConfig) getApplication()).getApplicationComponent())
               .realPlayModule(new RealPlayModule(this))
               .build()
               .inject(this);
    }
    @Override
    public void setPresenter(RealPlayContract.RealPlayContractPresenter presenter) {
        mPresenter = (RealPlayPresenter) presenter;
    }
    ...
    private void ptzOption(final EZConstants.EZPTZCommand command, final EZConstants.EZPTZAction action) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ptz_result = AppConfig.getOpenSDK().controlPTZ(mCameraInfo.getDeviceSerial(), mCameraInfo.getCameraNo(), command,
            ...
            Thread thr = new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        AppConfig.getOpenSDK().setVideoLevel(mCameraInfo.getDeviceSerial(), mCameraInfo.getCameraNo(), mode.getVideoLevel());
...
//    }
    ...
    private void onRecordBtnClick() {
        ...
        if (mEZPlayer != null) {
            ...
            String strRecordFile = Environment.getExternalStorageDirectory().getPath() + "/chuangxin/Records/" + String.format("%tY", date)
                ...
                public void run() {
                    ...
                    if (bmp != null) {
                        try {
                            ...
                            // 可以采用deviceSerial+时间作为文件命名，demo中简化，只用时间命名
                            java.util.Date date = new java.util.Date();
                            final String path = Environment.getExternalStorageDirectory().getPath() + "/chuangxin/CapturePicture/" + String.format("%tY", date)
                                    + String.format("%tm", date) + String.format("%td", date) + "/"
        ...
        if (mEZPlayer != null) {
            ...
            Thread thr = new Thread() {
                ...
                public void run() {
                    ...
                    if (bmp != null) {
                        try {
                            final String path = Environment.getExternalStorageDirectory().getPath() + "/chuangxin/CapturePicture/" +  DeviceSerial + Channel+".jpg";
                            if (TextUtils.isEmpty(path)) {
                                bmp.recycle();
                                bmp = null;
                                return;
    ...
    private void startRealPlay() {
        ...
        if (mCameraInfo != null) {
            if (mEZPlayer == null) {
                mEZPlayer = AppConfig.getOpenSDK().createPlayer(mCameraInfo.getDeviceSerial(), mCameraInfo.getCameraNo());
            }
...
//            }
            ...
            mEZPlayer = AppConfig.getOpenSDK().createPlayerWithUrl(mRtspUrl);
        ...
        tv_desc.setText("温馨提示：公共资源，提供" + remainTimeStamp + "秒观看时间\n剩余观看时间为:");
...
//                break;
    ...
    public void onInputVerifyCode(final String verifyCode) {
        KLog.i(TAG, "verify code is " + verifyCode);
