...
import com.yxld.yxchuangxin.ui.activity.xiongmai.lib.funsdk.support.config.AlarmInfo;
import com.yxld.yxchuangxin.ui.activity.xiongmai.lib.funsdk.support.config.BaseConfig;
import com.yxld.yxchuangxin.ui.activity.xiongmai.lib.funsdk.support.config.DevCmdGeneral;
import com.yxld.yxchuangxin.ui.activity.xiongmai.lib.funsdk.support.config.DevCmdOPFileQueryJP;
import com.yxld.yxchuangxin.ui.activity.xiongmai.lib.funsdk.support.config.DevCmdOPRemoveFileJP;
import com.yxld.yxchuangxin.ui.activity.xiongmai.lib.funsdk.support.config.DevCmdOPSCalendar;
import com.yxld.yxchuangxin.ui.activity.xiongmai.lib.funsdk.support.config.DevCmdSearchFileNumJP;
import com.yxld.yxchuangxin.ui.activity.xiongmai.lib.funsdk.support.config.DeviceGetJson;
import com.yxld.yxchuangxin.ui.activity.xiongmai.lib.funsdk.support.config.OPCompressPic;
import com.yxld.yxchuangxin.ui.activity.xiongmai.lib.funsdk.support.config.SameDayPicInfo;
...
import com.yxld.yxchuangxin.ui.activity.xiongmai.lib.funsdk.support.models.FunDeviceBuilder;
import com.yxld.yxchuangxin.ui.activity.xiongmai.lib.funsdk.support.models.FunLoginType;
import com.yxld.yxchuangxin.ui.activity.xiongmai.lib.funsdk.support.utils.DeviceWifiManager;
import com.yxld.yxchuangxin.ui.activity.xiongmai.lib.funsdk.support.utils.MyUtils;
import com.yxld.yxchuangxin.ui.activity.xiongmai.lib.funsdk.support.utils.SharedParamMng;
...
import com.yxld.yxchuangxin.ui.activity.xiongmai.lib.sdk.struct.H264_DVR_FINDINFO;
import com.yxld.yxchuangxin.ui.activity.xiongmai.lib.sdk.struct.OPRemoveFileJP;
import com.yxld.yxchuangxin.ui.activity.xiongmai.lib.sdk.struct.SDBDeviceInfo;
import com.yxld.yxchuangxin.ui.activity.xiongmai.lib.sdk.struct.SDK_Authority;
import com.yxld.yxchuangxin.ui.activity.xiongmai.lib.sdk.struct.SDK_CONFIG_NET_COMMON_V2;
import com.yxld.yxchuangxin.ui.activity.xiongmai.lib.sdk.struct.SDK_ChannelNameConfigAll;
import com.yxld.yxchuangxin.ui.activity.xiongmai.lib.sdk.struct.SDK_SearchByTime;
import com.yxld.yxchuangxin.ui.activity.xiongmai.lib.sdk.struct.SDK_TitleDot;
import com.yxld.yxchuangxin.ui.activity.xiongmai.lib.sdk.struct.SInitParam;
...
import static com.lib.FunSDK.SysInitLocal;
...
//	private static final int APP_MOVECARD = 2;
	private static final String APP_UUID = "4909a383863645c6801a4ca865b60b14";
	private static final String APP_KEY = "3ba930bbf0ca44c59ce1e67efbc6702a";
	private static final String APP_SECRET = "f239e57aa9324282b06efdd3b2cd8756";
...
//		FunLog.i(TAG, "FunSDK.InitServerIPPort:" + result);
	...
	public void setLoginType(FunLoginType loginType) {
		if (loginType == FunLoginType.LOGIN_BY_AP) {
			...
			SysInitLocal(FunPath.getLocalDB());
		} else {
...
//			}
	...
	public FunDevice getFunDeviceBySn(String devMac, String loginName, String loginPasswd) {
		FunDevice funDevice = findDeviceBySn(devMac);// findTempDevice(devMac);
		if (null == funDevice) {
			funDevice = new FunDevice();
			funDevice.devMac = devMac;
...
//			mDeviceGetConfigQueue.add(new DeviceGetConfig(funDevice, configName));
	 ...
	 * @return
	 */
	public FunDevice buildTempDeivce(FunDevType devType, String devMac) {
		FunDevice funDevice = findDeviceBySn(devMac);// findTempDevice(devMac);
		if (null == funDevice) {
			funDevice = new FunDevice();
			funDevice.devMac = devMac;
