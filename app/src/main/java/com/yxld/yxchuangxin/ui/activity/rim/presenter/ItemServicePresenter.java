 ...
 * @Description: presenter of ItemServiceFragment
 * @date 2017/06/16
 */
public class ItemServicePresenter implements ItemServiceContract.ItemServiceContractPresenter{
    ...
    @Inject
    public ItemServicePresenter(@NonNull HttpAPIWrapper httpAPIWrapper, @NonNull ItemServiceContract.View view) {
        mView = view;
