...
public class XinPingAdapter extends BaseQuickAdapter<GoodsKind.RowsBean.XinpinListsBean, BaseViewHolder> {
    public XinPingAdapter(@Nullable List<GoodsKind.RowsBean.XinpinListsBean> data) {
        super(R.layout.item_xinping, data);
    }

    @Override
    protected void convert(BaseViewHolder baseViewHolder, GoodsKind.RowsBean.XinpinListsBean goodBean) {
