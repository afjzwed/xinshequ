 ...
 * @Description: presenter of PaymentFragment
 * @date 2017/07/01 13:45:55
 */
public class PaymentPresenter implements PaymentContract.PaymentContractPresenter{
    ...
    @Inject
    public PaymentPresenter(@NonNull HttpAPIWrapper httpAPIWrapper, @NonNull PaymentContract.View view, PaymentFragment fragment) {
        mView = view;
    ...
    public void getList(Map map) {
        ...
        Disposable disposable = httpAPIWrapper.getPaymentList(map)
...
//                        ToastUtil.show(mFragment.getActivity(), mFragment.getString(R.string.loading_failed_1));
    ...
    @Override
    public void getJiaofei(Map map) {
        mView.showProgressDialog();
