 ...
 * @Description: presenter of CameraActivity
 * @date 2017/06/21 10:19:03
 */
public class CameraPresenter implements CameraContract.CameraContractPresenter{
    ...
    @Inject
    public CameraPresenter(@NonNull HttpAPIWrapper httpAPIWrapper, @NonNull CameraContract.View view, CameraActivity activity) {
        mView = view;
