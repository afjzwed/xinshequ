 ...
 * @Description: presenter of YwhWebViewActivity
...
public class YwhWebViewPresenter implements YwhWebViewContract.YwhWebViewContractPresenter{
    ...
    @Inject
    public YwhWebViewPresenter(@NonNull HttpAPIWrapper httpAPIWrapper, @NonNull YwhWebViewContract.View view, YwhWebViewActivity activity) {
        mView = view;
