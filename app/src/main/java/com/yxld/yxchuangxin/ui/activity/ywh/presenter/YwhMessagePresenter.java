 ...
 * @Description: presenter of YwhMessageFragment
 * @date 2018/11/09 17:04:05
 */
public class YwhMessagePresenter implements YwhMessageContract.YwhMessageContractPresenter{

    HttpAPIWrapper httpAPIWrapper;
    private final YwhMessageContract.View mView;
    private CompositeDisposable mCompositeDisposable;
    private YwhMessageFragment mFragment;

    @Inject
    public YwhMessagePresenter(@NonNull HttpAPIWrapper httpAPIWrapper, @NonNull YwhMessageContract.View view, YwhMessageFragment fragment) {
        mView = view;
