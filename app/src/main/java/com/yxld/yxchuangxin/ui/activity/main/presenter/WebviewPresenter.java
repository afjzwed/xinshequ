 ...
 */
public class WebviewPresenter implements WebviewContract.WebviewContractPresenter{
    ...
    @Inject
    public WebviewPresenter(@NonNull HttpAPIWrapper httpAPIWrapper, @NonNull WebviewContract.View view, WebviewActivity activity) {
        mView = view;
