 ...
 * @Description: presenter of PlayBackActivity
 * @date 2017/06/21 10:22:52
 */
public class PlayBackPresenter implements PlayBackContract.PlayBackContractPresenter{
    ...
    @Inject
    public PlayBackPresenter(@NonNull HttpAPIWrapper httpAPIWrapper, @NonNull PlayBackContract.View view, PlayBackActivity activity) {
        mView = view;
