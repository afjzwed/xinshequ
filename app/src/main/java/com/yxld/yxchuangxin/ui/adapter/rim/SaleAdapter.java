...
public class SaleAdapter extends BaseQuickAdapter<CxwyBusinessInfo.DataBean.ActivityBean,BaseViewHolder> {
    public SaleAdapter(List<CxwyBusinessInfo.DataBean.ActivityBean> data) {
