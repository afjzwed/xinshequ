 ...
 * @Description: presenter of XCameraActivity
 * @date 2017/07/17 16:30:10
 */
public class XCameraPresenter implements XCameraContract.XCameraContractPresenter{

    HttpAPIWrapper httpAPIWrapper;
    private final XCameraContract.View mView;
    private CompositeDisposable mCompositeDisposable;
    private XCameraActivity mActivity;

    @Inject
    public XCameraPresenter(@NonNull HttpAPIWrapper httpAPIWrapper, @NonNull XCameraContract.View view, XCameraActivity activity) {
        mView = view;
