 ...
 * @Description: presenter of GoodFenLeiFragment
...
public class GoodFenLeiPresenter implements GoodFenLeiContract.GoodFenLeiContractPresenter {
    ...
    @Inject
    public GoodFenLeiPresenter(@NonNull HttpAPIWrapper httpAPIWrapper, @NonNull GoodFenLeiContract.View view, GoodFenLeiFragment fragment) {
        mView = view;
    ...
    @Override
    public void loadMallGoodsFromServer(String feilei1 ,String feilei2, int rankType, int sortType, int inType, int currentPage, int onePageNum) {
//        if (currentPage == 1) {
//            oneremovedCOunt = 0;
//            allremovedCOunt = 0;
//        }
...
//        }
        ...
        map.put("fenlei1", feilei1);
        map.put("fenlei2", feilei2);
        map.put("page", currentPage + "");
        map.put("rows", onePageNum + "");
    ...
    @Override
    public void add2ShopCart(Map map, View view, String imgUrl) {
                ...
                .subscribe(new Consumer<BaseEntity>() {
                    ...
                    public void accept(@io.reactivex.annotations.NonNull BaseEntity baseEntity) throws Exception {
                        if (baseEntity.getStatus() == 1) {
                         mView.onAdd2ShopCartSuccess(view,imgUrl);
                        } else {
