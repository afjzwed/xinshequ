 ...
 * @Description: presenter of OrderListActivity
 * @date 2017/06/21 17:03:40
 */
public class OrderListPresenter implements OrderListContract.OrderListContractPresenter{
    ...
    @Inject
    public OrderListPresenter(@NonNull HttpAPIWrapper httpAPIWrapper, @NonNull OrderListContract.View view, OrderListActivity activity) {
        mView = view;
