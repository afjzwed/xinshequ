...
public class WechatPay {
	...
	public static String createOrder(String tradeNo, String totalFee, String subject,String payType) {
		...
		String result = "";
		String URL_PREPAY = API.IP_PRODUCT + "/pay/unifyOrder_wechatpay.mvc";
		try {
...
//			subject = URLEncoder.encode(subject, "UTF-8");
//			payType = URLEncoder.encode(payType, "UTF-8");
////			String url = "http://119.23.162.25:8080/wygl/payPark/orderinfo.mvc" + "?trade_no=" + tradeNo + "&total_fee=" + totalFee + "&subject=" + subject +"&payType="+payType;
//			String url = API.IP_PRODUCT + "/payPark/orderinfo.mvc" + "?trade_no=" + tradeNo + "&total_fee=" + totalFee + "&subject=" + subject + "&payType=" + payType+"&uuid="+ Contains.uuid;
//			KLog.i("createOrder: 'url="+url);
//			result = HttpUtils.doGet(url);
//			KLog.i("微信创建订单 result="+result.toString());
//		} catch (Exception e) {
...
//			String datajson = json.getString("datajson");
//			json = new JSONObject(datajson);
//			PayReq req = new PayReq();
////			req.appId = PayContain.WX_APP_ID;
//			req.appId = json.getString("AppId");
//			req.partnerId = json.getString("PartnerId");
////				req.partnerId		= PayContain.WX_MCH_ID;
